...
const elements = {
  ...
  // change to checkbox id when it is fixed.
  themeSwitch: document.getElementById('icon-dark'),
...
function setupEventListeners() {
  ...
  elements.editBoardButton.addEventListener('click', () => toggleBoardMenu(true));
  ...
  elements.deleteBoardBtn.addEventListener('click', (event) => deleteBoard());
}
...
function toggleSidebar(show){
  if(show){
    document.getElementById("side-bar-div").style.display="block"
  } else{
...
function toggleBoardMenu(){
  const show = document.getElementById("editBoardDiv").style.display === "block"
  if(!show){
